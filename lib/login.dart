        ...
        child: Column(
          ...
          children: [
            Center(
              child: Container(
                width: 40, height: 4,
                decoration: BoxDecoration(color: softGray, borderRadius: BorderRadius.circular(2)),
              ),
            ),
            ...
            Container(
              ...
              child: const Icon(Icons.lock_reset_rounded, color: orange, size: 24),
            ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: navyBlue.withOpacity(0.3), blurRadius: 12, offset: const Offset(0, 4))],
                ),
                child: const Center(
              ...
              children: [
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            height: 20,
                            decoration: BoxDecoration(
                              color: _rememberMe ? navyBlue : Colors.transparent,
                              borderRadius: BorderRadius.circular(5),
                              border: Border.all(
                                color: _rememberMe ? navyBlue : const Color(0xFFBDBDBD),
                                width: 2,
                              ),
                            ),
                            child: _rememberMe
                        ...
                        const Text('Remember me', style: TextStyle(fontSize: 13, color: steelBlue)),
                      ],
                    ),
                    GestureDetector(
                ...
                GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    padding: const EdgeInsets.symmetric(vertical: 16),
                    decoration: BoxDecoration(
                      color: _isLoading ? navyBlue.withOpacity(0.7) : orange,
                      borderRadius: BorderRadius.circular(14),
                      boxShadow: [
                        BoxShadow(
                          color: orange.withOpacity(_isLoading ? 0 : 0.35),
                          blurRadius: 14,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          label,
          style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: steelBlue),
        ),
        const SizedBox(height: 6),
        TextFormField(
