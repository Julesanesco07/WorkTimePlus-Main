...
class GreetingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final firstName = AppState().currentUser?.name.split(' ').first ?? 'there';
    ...
    switch (status) {
      case 'on_break':
        statusLabel = 'On Break';   statusColor = steelBlue;              statusBg = steelBlue.withOpacity(0.1); break;
      case 'working':
        statusLabel = 'Clocked In'; statusColor = Colors.green.shade600;  statusBg = const Color(0xFFE8F5E9);    break;
      case 'timed_out':
        statusLabel = 'Clocked Out'; statusColor = Colors.red.shade400;   statusBg = Colors.red.shade50;         break;
      default:
        statusLabel = 'Not Clocked In'; statusColor = const Color(0xFF9E9E9E); statusBg = softGray;
    }
              ...
              Wrap(spacing: 8, children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: availability == 'Available' ? const Color(0xFFFFF3E0) : softGray,
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      style: TextStyle(
                        ...
                        color: availability == 'Available' ? orange : const Color(0xFF9E9E9E),
                      ),
                      items: const [
                        DropdownMenuItem(value: 'Available',     child: Text('Available')),
                        DropdownMenuItem(value: 'Not Available', child: Text('Not Available')),
                      ],
                      onChanged: (val) => onAvailabilityChanged(val!),
                    ),
                  ),
                ),
              ]),
